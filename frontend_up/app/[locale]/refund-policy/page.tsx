                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground leading-relaxed text-sm sm:text-base">
                            This Refund and Cancellation Policy outlines the terms under which refunds may be issued for subscription plans purchased on Shramik Seva, a product of SDR Security. All payments are processed via <strong className="text-foreground">Paytm Payment Gateway</strong>.
                        </p>
                    </motion.div>
