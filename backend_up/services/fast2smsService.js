...
const sendOTP = async (mobile, otp) => {
    try {
        ...
        const url = `https://www.fast2sms.com/dev/bulkV2?route=dlt&sender_id=${FAST2SMS_SENDER_ID}&message=${FAST2SMS_TEMPLATE_ID}&variables_values=${otp}&flash=0&numbers=${cleanMobile}`;

        console.log('Sending OTP request to Fast2SMS URL:', url);
