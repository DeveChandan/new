...
exports.initiateWithPaytm = async (req, res) => {
    try {
        ...
        const calculatedAmount = await calculatePlanPrice(customerId, planId);
        ...
        // Add channelId and industryTypeId back - valid for Staging
        paytmParams.body.channelId = (process.env.PAYTM_CHANNEL_ID || "WAP").trim();
        ...
        const options = {
            hostname: WEBSITE === 'WEBSTAGING' ? 'securegw-stage.paytm.in' : 'securegw.paytm.in',
            port: 443,
...
exports.renderPaytmForm = async (req, res) => {
    try {
        ...
        const host = process.env.PAYTM_WEBSITE === 'WEBSTAGING' ? 'securegw-stage.paytm.in' : 'securegw.paytm.in';
